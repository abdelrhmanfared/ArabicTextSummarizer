...
# print("1")
mlFile = pd.read_csv(os.path.dirname(os.path.abspath(__file__)) + "\\TextVectors.csv")
# print("2")
...
model = pickle.load(open(os.path.dirname(os.path.abspath(__file__)) + "\\my_file.sav", 'rb'))
# print("5")
